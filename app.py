...
if ENV == 'dev':
    ...
    app.debug = False
    app.config['SQLALCHEMY_DATABASE_URI'] = 'postgres://nncytayolubupq:77e80ae046cc6b1e8d52c784913f9cd4c1e3959f5e4f9e34c4988712c9b9a88e@ec2-44-205-112-253.compute-1.amazonaws.com:5432/d1jv0hnlrnkfo8'
